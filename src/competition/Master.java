...
public class Master extends Competition {
   ...
   * @param method the method of selecting the competitors
   */
  public Master(List<Competitor> competitors, int nbpoule, Method method){
    super(competitors);
    this.method = method;
   ...
   */
   ...
   public void playLeague(List<Competitor> competitors) throws NumberNotPowerOf2Exception{
     ...
     int i = this.method.selection(ligue).size();
     int v = 1;
     if ((i != 0) && ((i & (i - 1)) == 0)){
       for (League l : ligue){
         System.out.println("");
  ...
  public void playTournament() throws NumberNotPowerOf2Exception{
    tournament = new Tournament(this.method.selection(this.league));
    System.out.println("");
