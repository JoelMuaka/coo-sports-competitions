...
public class SelectFirstTwo implements Method {

  /**
   * Select the first two competitors in each league from the list passed in parameter
   ...
   */
    ...
    List<Competitor> theFinaliste= new ArrayList<Competitor>();
      ...
      theFinaliste.add(l1.get(0));
      theFinaliste.add(l1.get(1));
		}
		return theFinaliste;
  }
}
